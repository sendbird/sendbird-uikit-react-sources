...
const stringSet = {
  en: {
    ...
    MESSAGE_INPUT__PLACE_HOLDER__DISABLED_FOR_OFFLINE: 'Check your network to send messages',
    ...
    CSAT_RATING_SUBMIT_TITLE: 'Thank you!',
    CSAT_RATING_SUBMIT_SUBTITLE: 'Tell us more about your experience',
    CSAT_RATING_SUBMIT_PLACEHOLDER: 'Share your feedback',
    CSAT_RATING_SUBMIT_BTN_CANCEL: 'Cancel',
    CSAT_RATING_SUBMIT_BTN_OK: 'Submit',
    CSAT_RATING_TITLE: 'How was your experience today?',
    CSAT_RATING_SUBTITLE: 'Your feedback helps us serve you better.',
